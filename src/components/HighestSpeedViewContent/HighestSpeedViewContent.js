...
class HighestSpeedViewContent extends React.Component {
    state = {
        DateTo: new Date(),
        DateFrom: new Date()
    };
                                    ...
                                    <Row>
                                        <Col>
                                            ...
                                            <Row>
                                                ...
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Speed(kmph)</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(255,106,107,0.55)"}}>200</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col className="columncenter" md="2" xs="2">
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>180</a>
                                                </Col>
                                            </Row>
                                            ...
                                            <Row>
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>166</a>
                                                </Col>
                                            </Row>
...
export default HighestSpeedViewContent;
