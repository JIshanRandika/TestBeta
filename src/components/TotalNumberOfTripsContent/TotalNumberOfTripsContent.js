...
class TotalNumberOfTripsContent extends React.Component {
    state = {
        DateTo: new Date(),
        DateFrom: new Date()
    };
                                        ...
                                        <Col>
                                            ...
                                            <Row>
                                                ...
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Total No of Trips</a>
                                                </Col>
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}></a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>3</a>
                                                </Col>
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a href="/tripsdetail">
                                                    <Card className="shadow" style={{width:"42px", height:"16px",borderRadius:10, marginTop:"0px"}}>

                                                        <div className="columncenter font-weight-bold" style={{fontSize: 10, color:"rgba(0,64,255,0.55)"}}>
                                                            More
                                                        </div>

                                                    </Card>
                                                    </a>
                                                    {/*<a className="font-weight-bold columncenter shadow" style={{fontSize: 10, color:"rgba(0,64,255,0.55)"}}>More</a>*/}
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col className="columncenter" md="2" xs="2">
...
export default TotalNumberOfTripsContent;
