...
class TotalDistanceViewContent extends React.Component {
    state = {
        DateTo: new Date(),
        DateFrom: new Date()
    };
                                ...
                                <div className="mx-auto my-3" style={{ width:"80%"}}>
                                    ...
                                    <Row>
                                        <Col>
                                            ...
                                            <Row>
                                                <Col className="icon-shape" md="3" xs="2">
                                                ...
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Total Distance(Km)</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col className="columncenter" md="3" xs="2">
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>10</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col className="columncenter" md="3" xs="2">
...
export default TotalDistanceViewContent;
