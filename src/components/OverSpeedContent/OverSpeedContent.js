...
class OverSpeedContent extends React.Component {
    state = {
        DateTo: new Date(),
        DateFrom: new Date()
    };
                        ...
                        <Row>
                            ...
                            <div className="mx-auto mb-5" style={{ backgroundColor:"#feffff", width:"80%"}}>
                                <div className="mx-auto my-3" style={{ width:"80%"}}>
                                    ...
                                    {/*</Row>*/}
                                    {/*<Row>*/}
                                    {/*    <Col className="icon-shape" md="3" xs="12">*/}
                                    {/*        <form  noValidate autoComplete="off" style={{fontSize: 15,}}>*/}
                                    {/*            <TextField id="standard-basic" label="Min(kmph)" />*/}
                                    {/*        </form>*/}
                                    {/*    </Col>*/}
                                    {/*    <Col className="icon-shape" md="3" xs="12">*/}
                                    {/*        <form  noValidate autoComplete="off" style={{fontSize: 15,}}>*/}
                                    {/*            <TextField id="standard-basic" label="Max(kmph)" />*/}
                                    {/*        </form>*/}
                                    {/*    </Col>*/}
                                    {/*    <Col className="icon-shape" md="3" xs="12">*/}
                                    {/*        <form  noValidate autoComplete="off" style={{fontSize: 15,}}>*/}
                                    {/*            <TextField id="standard-basic" label="Vehicke ID" />*/}
                                    {/*        </form>*/}
                                    {/*    </Col>*/}
                                    {/*    <Col className="icon-shape" md="3" xs="12">*/}
                                    {/*        <form  noValidate autoComplete="off" style={{fontSize: 15,}}>*/}
                                    ...
                                    <Row>
                                        <Col>
                                            ...
                                            <Row>
                                                ...
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Speed</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>16:26:24-18:26:24</a>
                                                </Col>
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>Low</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col className="columncenter" md="2" xs="2">
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>High</a>
                                                </Col>
                                            </Row>
                                            ...
                                            <Row>
                                                ...
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>Normal</a>
                                                </Col>
                                            </Row>
...
export default OverSpeedContent;
