...
class GeozoneReportViewContent extends React.Component {
    state = {
        DateTo: new Date(),
        DateFrom: new Date()
    };
                                    ...
                                    <Row>
                                        <Col>
                                            <Row>
                                                ...
                                                <Col md="4" xs="4">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(255,76,182,0.7)"}}>Kalutara</a>
                                                </Col>
                                                <Col md="6" xs="6">
                                            ...
                                            <Row>
                                                ...
                                                <Col className="icon-shape" md="2" xs="2">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Enter Time</a>
                                                </Col>
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Exit Time</a>
                                                </Col>
                                                <Col className="icon-shape" md="3" xs="3">
                                                    <a className="font-weight-bold" style={{fontSize: 15, color:"rgba(10,90,145,0.55)"}}>Distance(Km)</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                ...
                                                <Col className="columncenter" md="2" xs="2">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>14:20:28</a>
                                                </Col>
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>16:26:24</a>
                                                </Col>
                                                <Col className="columncenter" md="3" xs="3">
                                                    <a className="" style={{fontSize: 15, color:"rgba(0,64,255,0.55)"}}>16.5</a>
                                                </Col>
                                            </Row>
                                            <Row>
                                                <Col className="columncenter" md="2" xs="2">
...
export default GeozoneReportViewContent;
